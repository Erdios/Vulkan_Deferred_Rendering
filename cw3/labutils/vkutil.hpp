...
namespace labutils
{
	...
	void image_barrier(VkCommandBuffer, VkImage, VkAccessFlags aSrcAccessMask, VkAccessFlags aDstAccessMask,
	...
	DescriptorPool create_descriptor_pool(VulkanContext const& aContext, std::uint32_t aMaxDescriptors = 2048,
	...
	Sampler create_default_sampler(VulkanContext const&, VkBool32 useAnisotropy);
